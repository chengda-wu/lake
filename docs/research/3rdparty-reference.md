...
> 生态相连:vLLM `KVConnectorBase_V1` 被 LMCache/Mooncake/NIXL 等实现;vLLM-Ascend 另将 **MemCache** 与 Mooncake/Yuanrong 列为 KV Pool backend;SGLang HiCache 把 Mooncake 作 L3;Dynamo 编排 vLLM/SGLang。我们站在其上做更彻底的存算分离。
