...
详见 [compute.md](compute.md)(计算层抽象与 connector 接口)、[block-lifecycle.md](block-lifecycle.md)(block 释放/驱逐/offload 生命周期)、[pain-points.md](pain-points.md)(上游痛点与 lake 对照)、[../guided-decoding.md](../guided-decoding.md)(structured output × async scheduling 同步气泡)。
