...
- **SGLang HiCache** → [`sglang/`](sglang/):[总览](sglang/overview.md) · [分层机制](sglang/hicache.md) · [存储后端](sglang/storage-backends.md) · [thinking 控制](sglang/thinking-control.md) · [上游痛点](sglang/pain-points.md)
  - L1/L2/L3 三层(L1/L2 私有、L3 共享)、HiRadixTree、prefetch/write-back 策略;issue/roadmap 痛点与 lake 对照见 pain-points。
