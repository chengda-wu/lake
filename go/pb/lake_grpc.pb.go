...
func (UnimplementedControlPlaneServiceServer) SubscribeView(*SubscribeRequest, grpc.ServerStreamingServer[ViewUpdate]) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeView not implemented")
}
func (UnimplementedControlPlaneServiceServer) LookupPrefix(context.Context, *LookupPrefixRequest) (*LookupPrefixResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LookupPrefix not implemented")
}
...
func (UnimplementedControlPlaneServiceServer) RegisterBlocks(context.Context, *RegisterBlocksRequest) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterBlocks not implemented")
}
func (UnimplementedControlPlaneServiceServer) RequestBarrier(context.Context, *RequestBarrierRequest) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestBarrier not implemented")
}
...
func (UnimplementedAgentServiceServer) PlaceBlocks(context.Context, *PlaceBlocksRequest) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PlaceBlocks not implemented")
}
...
func RegisterSkeletonKvServiceServer(s grpc.ServiceRegistrar, srv SkeletonKvServiceServer) {
	// If the following call pancis, it indicates UnimplementedSkeletonKvServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
